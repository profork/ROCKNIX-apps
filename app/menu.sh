...
RUN=(
  ...
  [14a]="echo 'Free Homebrew ROM Pack...'; curl -L https://github.com/profork/ROCKNIX-apps/raw/main/freebatroms.sh | bash"
  [14b]="echo 'Free Batocera Content Downloader ROM Pack...'; curl -L https://github.com/profork/ROCKNIX-apps/raw/main/bfr.sh | bash"
...
OPTIONS=(
  ...
  "12" "ES Carbon Theme"
  "13" "ES Music Pack"
  "14a" "Free Homebrew ROM Pack"
  "14b" "Free Batocera Content Downloader ROM Pack"
